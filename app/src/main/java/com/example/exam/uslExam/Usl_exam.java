package com.example.exam.uslExam;
...
import com.example.exam.db.UslHistory1;
import com.example.exam.db.UslHistory2;
import com.example.exam.db.UslHistoryAll;
import com.example.exam.db.Question1;
...
public class Usl_exam extends AppCompatActivity{
    ...
    private List<Question1> list = new ArrayList<Question1>();
    ...
    private void initDB() {
            ...
            final BmobQuery<Question1> query = new BmobQuery<Question1>();
            query.findObjects(new FindListener<Question1>() {
            @Override
            public void done(final List<Question1> list1, BmobException e) {
                if (e == null) {
                    for (int i = 0; i < list1.size(); i++) {
                        BmobQuery<UslHistoryAll> query1 = new BmobQuery<UslHistoryAll>();
                        query1.addWhereEqualTo("question_id", list1.get(i).getID());
                        query1.addWhereEqualTo("user_id",id);
                        final int finalI = i;
                        query1.findObjects(new FindListener<UslHistoryAll>() {
                            @Override
                            public void done(List<UslHistoryAll> list2, BmobException e) {
                                if(e==null)
                                {
                                    if (list2.size() == 0) {
                                        boolean a = list.add(list1.get(finalI));
                                        t++;
                                        if (t == 20 || finalI == list1.size() - 1) {
                                            corrent = 0;
                                            ...
                                            btn_down.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    ...
                                                    if (corrent < list.size() - 1) {
                                                        ...
                                                        new AlertDialog.Builder(Usl_exam.this).setTitle("提示").setMessage("已经到达最后一道题，是否退出？")
                                                        ...
                                                        //提示已是最后一题
                                                        new AlertDialog.Builder(Usl_exam.this).setTitle("提示").setMessage("已经到达最后一道题")
                                                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                                                    @Override
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        UslHistory history = new UslHistory();
                                                                        UslHistory1 history1 = new UslHistory1();
                                                                        UslHistory2 history2 = new UslHistory2();
                                                                        ...
                                                                        for (int i = 0; i < 20; i++) {
                                                                            UslHistoryAll uslHistoryAll = new UslHistoryAll();
                                                                            uslHistoryAll.setUser_id(id);
                                                                            uslHistoryAll.setTime(created);
                                                                            uslHistoryAll.setQuestion_id(question_id[i]);
                                                                            uslHistoryAll.setSelectedAnswer(selectedAnswer[i]);
                                                                            uslHistoryAll.setScore(0);
                                                                            uslHistoryAll.save(new SaveListener<String>() {
                                                                                @Override
                                                                                public void done(String s, BmobException e) {
                                                                        ...
                                                                        if (wrongList.size() == 0) {
                                                                            new AlertDialog.Builder(Usl_exam.this).setTitle("提示").setMessage("你好厉害，答对了所有题！")
                                                                                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                                                                        @Override
                                                                                        public void onClick(DialogInterface dialog, int which) {
                                                                                            finish();
                                                                        ...
                                                                        new AlertDialog.Builder(Usl_exam.this).setTitle("恭喜，答题完成！")
                                                                            ...
                                                                            public void onClick(DialogInterface dialog, int which) {
                                                                                ...
                                                                                if (wrongList.size() > 0) {
                                                                                    wrongmode = true;
                                                                                    List<Question1> newList = new ArrayList<Question1>();
                                                                    ...
                                                                    private List<Integer> checkAnswer(List<Question1> list) {

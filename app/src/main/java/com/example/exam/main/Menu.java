...
import com.example.exam.game.MainActivity;
import com.example.exam.midExam.Mid_exam;
import com.example.exam.uslExam.Usl_exam;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.nav_history:
                        Intent intent = new Intent(Menu.this, HistoryView.class);
    ...
    private void initCr() {
        mid_exam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(Menu.this, Mid_exam.class);
                intent1.putExtra("id",id);
                startActivity(intent1);
            }
        });
        ...
        usl_exam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3 = new Intent(Menu.this, Usl_exam.class);
        ...
        rank.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent4 = new Intent(Menu.this, Rank.class);
